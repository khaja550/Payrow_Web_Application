    ...
    // public data: Object[] = [
    //   { x: 'Jan', y: 206, text: 'Bangaladesh' },
    //   { x: 'Feb', y: 123, text: 'Bhutn' },
    //   { x: 'Mar', y: 48, text: 'Nepal' },
    //   { x: 'Apr', y: 230, text: 'Thiland' },
    //   { x: 'May', y: 170, text: 'Malaysia' },
    //   { x: 'Jun', y: 110, text: 'Malaysia' },
    //   { x: 'July', y: 170, text: 'Malaysia' },
    //   { x: 'Aug', y: 130, text: 'Malaysia' },
    //   { x: 'Sept', y: 241, text: 'Malaysia' },
    //   { x: 'Oct', y: 190, text: 'Malaysia' },
    //   { x: 'Nov', y: 120, text: 'Malaysia' },
    //   { x: 'Dec', y: 160, text: 'Malaysia' },
    // ];
    ...
    constructor(private app: AppManagerService, private router: Router,private opCentre:OpCenterService) {
    ...
    ngOnInit(): void {
        ...
        this.prYAxis['labelFormat'] = this.shortNumber !== undefined ? '{value}' + `${this.shortNumber}` : '{value}'
    ...
    barChartData() {
        ...
        this.data = [];
        let max: any;
		this.opCentre.appDownloads().subscribe((data:any)=>{
			this.yearlyData =  data.data.types;
    ...
    ngAfterViewInit(): void {
        ...
        // if (URLs.indexOf(curUrl) !== -1) this.isDashboardURL = true;
        // else this.isDashboardURL = false;
